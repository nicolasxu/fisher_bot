...
//	private final AdvisorPanel m_advisorPanel = new AdvisorPanel();
	...
	private final StratPanel m_stratPanel = new StratPanel();
        private final VixHedgePanel m_vixHedgePanel = new VixHedgePanel();
	...
	private void run() {
		...
		m_tabbedPanel.addTab( "Market DataTank", m_mktDataPanel);
		...
		m_tabbedPanel.addTab( "Contract Info", m_contractInfoPanel);
                m_tabbedPanel.addTab("Vix Hedge", m_vixHedgePanel);
